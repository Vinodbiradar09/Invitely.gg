const steps = [
  {
    ...
    desc: "Organise your contacts into groups Family, College, Office, Close Friends. Add names and emails once. Reuse forever.",
    detail: "Up to 5 workspaces · 25 members each",
  },
  {
    number: "02",
    title: "Write your invite",
    desc: "Type your message in plain casual language. Our AI optmizes it into a proper, warm invitation email with the right subject and tone.",
    detail: "AI powered · Editable output",
  },
  {
    number: "03",
    title: "Select & send",
    desc: "Pick entire workspaces or specific people. Preview exactly what they'll receive. Hit send we deliver to everyone at once.",
    detail: "Batch delivery · Real-time RSVP tracking",
  },
];
